...
case "$choice" in
    ...
    3)
        ...
        if [ "$HAS_GIT" = true ]; then
            ...
            echo -e "源码目录: ${CYAN}$INSTALL_DIR${NC}"
            echo -e "运行示例: ${CYAN}python3 $INSTALL_DIR/zhexue/bazi.py 2007 9 28 20 8 male${NC}"
        else
...
echo ""
echo "  # 八字排盘"
echo "  bazi 2007 9 28 20 8 male"
echo ""
echo "  # 用神分析"
echo "  yongshen 2007 9 28 20 8 male"
echo ""
echo "  # 称骨算命"
echo "  chenggu 丁亥 8 18 戌"
echo ""
echo "  # 交互查询"
echo "  bazi 2007 9 28 20 8 male --liunian 2035"
echo "  bazi 2007 9 28 20 8 male --liuyue 2026-08"
echo "  bazi 2007 9 28 20 8 male --liuri 2028-03-15"
echo ""
echo -e "${CYAN}========================================${NC}"
